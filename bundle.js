...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;EACT,UAAU;AACZ;AACA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,kBAAkB;EAClB,qCAAqC;EACrC,aAAa;AACf;AACA;EACE,aAAa;EACb,SAAS;EACT,mBAAmB;AACrB;AACA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,mBAAmB;EACnB,eAAe;AACjB;AACA;EACE,mBAAmB;EACnB,WAAW;AACb","sourcesContent":["body {\n  font-family: Arial, sans-serif;\n  background: #f4f4f4;\n  margin: 0;\n  padding: 0;\n}\n#app {\n  max-width: 800px;\n  margin: 40px auto;\n  background: #fff;\n  border-radius: 8px;\n  box-shadow: 0 2px 8px rgba(0,0,0,0.1);\n  padding: 24px;\n}\n.projects-list {\n  display: flex;\n  gap: 12px;\n  margin-bottom: 24px;\n}\n.project-item {\n  padding: 8px 16px;\n  border-radius: 4px;\n  background: #e0e0e0;\n  cursor: pointer;\n}\n.project-item.selected {\n  background: #1976d2;\n  color: #fff;\n}\n"],"sourceRoot":""}]);
// Exports
...
let projects = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.loadData)() || [new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"]({ name: 'Default Project' })];
...
function renderTodos() {
	...
	if (project) {
		...
		form.onsubmit = e => {
			...
			if (title) {
				const newTodo = new _todo_js__WEBPACK_IMPORTED_MODULE_1__["default"]({ title, dueDate, priority });
	...
	project.todos.forEach(todo => {
		...
		let formattedDate = '';
		if (todo.dueDate) {
			const parsed = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.parseISO)(todo.dueDate);
			formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isValid)(parsed) ? (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(parsed, 'MMM d, yyyy') : todo.dueDate;
		}
